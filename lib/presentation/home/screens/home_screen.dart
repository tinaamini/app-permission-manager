                              ...
                              children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: BtnHomeWidget(
                                        ...
                                        textCount:
                                            '$countText ${l10n.appsChecked}',
                                        ontap: () => context.pushNamed(
                                            RouteName.appsPermission),
                                      ),
                                    ),
                                ...
                                if (kDebugMode) ...[
                                  ...
                                  OutlinedButton.icon(
                                    onPressed: () {
                                      throw StateError(
                                        'Firebase Crashlytics test error',
                                      );
                                    },
                                  ...
                                  OutlinedButton.icon(
                                    onPressed: () {
                                      unawaited(AppMetrica.reportError(
                                        message: 'AppMetrica test error',
                                        errorDescription:
                                            AppMetricaErrorDescription
                                                .fromCurrentStackTrace(
                                          message:
                                              'Manual AppMetrica test error',
                                          type: 'AppMetricaTestError',
                                        ),
                                      ));
                                      unawaited(AppMetrica.sendEventsBuffer());
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        const SnackBar(
                                          content: Text(
                                            'AppMetrica test error queued',
                                          ),
                                        ),
                                      );
                                    },
